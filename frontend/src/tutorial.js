              ...
              <Container  >
                ...
                <Jumbotron fluid style={{ borderRadius: "20px", border: "solid", borderWidth: "1px", borderColor: "gray" }}>
                  <Container>
                    <Row>
                      <Col sm="8">
                        <h1 style={{ textAlign: "left" }}>{subsection.title} <Link to={'#' + subsection.id} style={{ color: 'gray' }}>#</Link></h1>
                        <hr />
                ...
                <Challenges challenges={subsection.challenges} id={subsection.id} />
...
function Challenges(props) {
  ...
  return (
    <Card id={props.id + '-challenges'} style={{ borderRadius: "15px", backgroundColor: "white", borderWidth: "1px", margin: "1vh" }}>
      <Card.Body>
        <Row >
          <Col xs="11">
...
const sections = [
    ...
    subsections:
      ...
      [

        {
          ...
          //Final
          final:
            <Container> This is the final imaget </Container>,
        ...
        {
          title: "The Workspace", id: 'workspace',
  ...
  //+------------------+
  {
    ...
    subsections:
      ...
      //+---------------------+
      {
        title: "Time and Animations", id: 'time-animations',
        ...
        text:
          <Container>
            ...
            <br />
            2. Drag in a <b>mult</b> block and connect the <b>x</b> and <b>t.s</b> to it. Now you can see time changes what was once a a simple <b>x</b> image.
            <br />
      ...
      //+------------------------+
      {
        title: "Moving with the Mouse", id: 'moving-with-mouse',
        ...
        text:
          <Container>
            Moving with the mouse means that you can change what the image looks like just by moving your mouse around on the image. In order to do this, the <b>m.x</b> block, <b>m.y</b> block, or both must be used.
              ...
              To try it yourself:
              <br />
              1. Bring a <b>x</b>, <b>y</b>,<b>m.x</b> and <b>m.y</b> variable into the workspace.
              <br />
              2. Then add a <b>wsum</b> in and connect all 4 variables to it. You should have a simple animation that moves when you hover over it!
          </Container>,
  ...
  //+------------------+
  {
    ...
    subsections:
      [{
        title: "Multiple Inputs", id: 'multiple-input',
        ...
        text:
          <Container>
            Multiple input functions are functions that must have at least 2 inputs and can have up to 20. These functions include <b>sum</b>, <b>wsum</b>, <b>mult</b>, and <b>avg</b>.
              ...
              <br />
              3. Connect the <b>x</b> to the <b>sum</b> block twice, and then the <b>y</b> to the <b>mult</b> twice.
              <br />
              4. Then bring in an <b>avg</b> block and connect the <b>sum</b> and <b>mult</b> block to it! Now take a look at your final image!
          </Container>,
      ...
      //+------------------+
      {
        title: "Fixed Inputs", id: 'fixed-input',
        keywords: ["inputs", "grayscale", "image"],
        ...
        text:
          <Container>
            ...
            <br />
            1. Drag a <b>x</b> and <b>y</b> variable into the workspace along with an <b>if</b> block.
            <br />
            2. Connect the <b>x</b> to the first two nodes of the <b>if</b> block.
            <br />
            3. Then, connect the <b>y</b> variable to the third node of the <b>if</b> block. In this example , the test case, which is the first input, is <b>x</b>. So while the input is less than 0, the returned value is negative, which means that it calls <b>y</b>. When it reaches 0 or greater, it returns positive, which in this case is x. This is why the image looks "split" in this case.
  ...
  //+------------------+
  {
    ...
    subsections:
      [{
        ...
        image: <MISTImage code='sign(wsum(square(x),square(y)))' resolution="250" />,
        isAnimated: false,
        //Text
        text:
          <Container>
      ...
      //+------------------+
      {
        title: "Rhombus",
         id: 'rhombus',
        keywords: ["shape", "grayscale", "image"],
        image: <MISTImage code='sign(sum(mult(2, x, mistif(x, -1, 1)), mult(2, y, mistif(y, -1, 1)), 2))' resolution="250" />,
     isAnimated: false,
        //Text
        text:
          <Container>
            ...
            <br />
            3. When connecting to the <b>if</b> statement, make sure it goes in the correct order! This is very important.
            Connect the <b>x</b> to the first node of the if statement.
            <br />
            4. Then, connect <b>-1</b> to the second node. This means that if x is a positive number or 0, it will return this -1.
            <br />
            5. After that, connect <b>1</b> to the third node.
            If the input is less than 0, it will return 1.
             This is why when you click the preview for if, the right side is white and the left side is black.
              You can see what it should look below!
            <br />
            6. Next, add <b>x</b> and a <b>value</b> block to the workspace. Set the value of this block equal to <b>2</b>.
            <br />
            ...
            <br />
            8. Now repeat steps 1-7, but this time using <b>y</b> instead of <b>x</b>.
            This will change the pattern from a vertical split to a horizontal one.
            We'll write the steps below just in case (or jump to step 12).
            <br />
            ...
            <br />
            12. After this is completed, let’s add a <b>sum</b> block. Connect this to the <b>mult</b> blocks we used with <b>x</b>, and with <b>y</b> to it.
            <br />
            13. We’re also going to add another value block and set it to <b>2</b>.
            Then, connect it to the sum block.
             We should now have a diamond shaped rhombus outline!
            <br />
            14. To make this image more clear, we’re going to add a <b>sign</b> block. Connect <b>sum</b> to <b>sign</b> and click the preview; you should see a rhombus!
          </Container>,
    ...
    subsections:
      [
        /* Flipping */
        {
          ...
          text:
            <Container>
              Flipping an image means that you create the impression of flipping an image when you invert the colors!
              You can flip it horizontally or vertically (on the x or the y axis). Here is an example with a simple triangle.
              <br />
        ...
        //+------------------+
        {
          title: "Moving around", id: 'moving-around',
          keywords: ["shape", "grayscale", "image"],
          image: <MISTImage code='wsum(square(sum(x,0.5)),square(y))' resolution="250" />,
          isAnimated: false,
          //Text
          text:
            <Container>
        ...
        //+------------------+
        {
          title: "Assemble", id: 'assemble',
          keywords: ["graph", "grayscale", "axis"],
          image: <MISTImage code='mistif(sign(wsum(square(x),square(y))),y,sign(sum(x,y)))' resolution="250" />,
          isAnimated: false,
          //Text
          text:
            <Container>
              You might have created some cool pictures by now. In this tutorial you will learn how to put them together into one piece. To do so, we need to use the if function. Let’s say you have the following 3 images:
              <br />
              And you want to make it into the following:
              <br />
              It uses the circle outline, and uses the second picture as the inside of the circle and the third picture as the outside of the circle. You just need to connect them together with an if function:
              <br />
              Remember what if does? It takes 3 inputs in -- 3 images. It uses the second image in all the positive parts of the first image, and the third imagery all the negative parts of the image.
              <br />
              In the above example, the second image (y) is being used at the positive parts (black parts) of the first image (the circle). Whereas the third image (the triangle) is being used at the negative parts (white parts) of the first image (the circle).
              <br />
              So how would it look like if the order was the following with the following images:
              <br />
              (These are the same images as in the previous one except the circle is blended.
              <br />
              It looks the following:
              <br />
              This is because sign changes all negative parts into white, and positive parts into black. By adding a sign function on the first image input, you will have an easier time seeing through the different parts of the image and the exact dividers.
              <br />
              You can also think in quadrants, like in math with graphs and coordinates.
              For example you can use four different images to make the following:
              <br />
  ...
  //+---------------------------+
  {
    ...
    subsections:
      [{
        ...
        image: <MISTImage code='rgb(sin(sin(cos(x))),mult(sin(sin(cos(x))),y),wsum(y,t.s))' resolution="250" />,
        isAnimated: false,
        //Text
        text:
          <Container>
      ...
      //+------------------+
      {
        ...
        image: <MISTImage code='sin(wsum(neg(square(x)),neg(y),mult(t.s,m.y),m.x,mult(x,y)))'
          resolution="250" />,
          isAnimated: false,
        //Text
        text:
          <Container>
            ...
            2. Next, add a <b>sqr</b>, <b>mult</b>, and <b>neg</b>. Connect the
             <b>x</b> to the <b>sqr</b> and <b>mult</b> and the <b>y</b> to the <b>mult</b> and <b>neg</b>.
            <br />
            3. Then bring in another <b>neg</b> block and connect the <b>sqr</b> to this.
            <br />
            4. Add a <b>t.s</b>, <b>m.x</b>, and <b>m.y</b>.
            <br />
            5. Connect the <b>t.s</b> and <b>m.y</b> to  the new <b>mult</b> block in the workspace.
            and it.
            <br />
            6. On their own, the images look simple, but now it's time to put it all together. Start by adding a
             <b>wsum</b>. From there, connect both of the <b>neg</b> blocks and <b>mult</b> blocks. Additionally, connect
             the <b>m.x</b> block to the <b>wsum</b> block as well.
            <br />
